...
import org.darkaforest.model.FileType;
import org.darkaforest.service.cache.CacheService;
import org.darkaforest.service.cache.NotResourceCache;
import org.darkaforest.utils.EncodingDetects;
import org.darkaforest.utils.KkFileUtils;
import org.darkaforest.utils.UrlEncoderUtils;
import org.darkaforest.utils.WebUtils;
import org.darkaforest.web.filter.BaseUrlFilter;
...
public class FileHandlerService implements InitializingBean {
    ...
    public void doActionConvertedFile(String outFilePath) {
        ...
        try (InputStream inputStream = new FileInputStream(outFilePath); BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream, charset))) {
            ...
            // 添加sheet控制头
            sb.append("<script src=\"proxyfile-preview/js/jquery-3.6.1.min.js\" type=\"text/javascript\"></script>");
            sb.append("<script src=\"proxyfile-preview/excel/excel.header.js\" type=\"text/javascript\"></script>");
            sb.append("<link rel=\"stylesheet\" href=\"proxyfile-preview/excel/excel.css\">");
        } catch (IOException e) {
            e.printStackTrace();
        }
        // 重新写入文件
