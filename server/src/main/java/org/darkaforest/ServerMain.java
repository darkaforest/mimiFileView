...
@EnableScheduling
@ComponentScan(value = "org.darkaforest.*")
public class ServerMain {
    ...
    public static void main(String[] args) {
        ...
        logger.info("mimiFileView 服务启动完成，耗时:{}s，演示页请访问: http://127.0.0.1:{} ", stopWatch.getTotalTimeSeconds(), urlSuffix);
    }
